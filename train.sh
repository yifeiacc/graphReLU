...
# python gcn.py --dataset flickr --normalize_features False --random_splits true
# python gcn.py --dataset BlogCatalog --normalize_features False --random_splits true
...
# python sage.py --dataset BlogCatalog --normalize_features False --random_splits true
...
# python cheb.py --dataset flickr --normalize_features False --random_splits true
# python cheb.py --dataset BlogCatalog --normalize_features False --random_splits true
...
# python arma.py --dataset flickr --normalize_features False --random_splits true
# python arma.py --dataset BlogCatalog --normalize_features False --random_splits true
...
# python gat.py --dataset flickr --normalize_features False --random_splits true
# python gat.py --dataset BlogCatalog --normalize_features False --random_splits true
